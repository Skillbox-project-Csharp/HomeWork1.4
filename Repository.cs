...
namespace Homework_01
{
    ...
    class Repository
    {
        ...
        /// <summary>
        /// Метод, увольняющий определенное количество последних работников в списке 
        /// </summary>
        /// <param name="Count">Количество работников, которых нужно уволить</param>
        public void DeleteEndWorker(int Count)
        {
            if(Count <= this.Workers.Count())
                for(int i = 0; i < Count; i++)
                    this.Workers.RemoveAt(this.Workers.Count()-1);//Удаление последнего работника в списке
        }
    }
}
